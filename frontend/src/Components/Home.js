...
function AppHome() {
  ...
  useEffect(() => {
    ...
    const getCustomerCount = async () => {
      let { data } = await axios.get(
        "http://localhost:8000/api/v1/dashboard/customer"
      );
    ...
    const getVehicleCount = async () => {
      let { data } = await axios.get(
        "http://localhost:8000/api/v1/dashboard/vehicle"
      );
      setVehicleCount(data);
    };
    const getDriverCount = async () => {
      let { data } = await axios.get(
        "http://localhost:8000/api/v1/dashboard/driver"
      );
      setDriverCount(data);
    };
      ...
      <section id="home" className="home">
        <Container fluid>
          <Row className="ms-5 mt-5">
            ...
            >
              <div>
                <h3 className="fs-2 p-3 fw-bold"> {orderCount == null ? (
                    <>
                      <h6>Loading</h6>
                    </>
                  ) : (
            ...
            >
              <div>
                <h3 className="fs-2 p-3 fw-bold"> {routesCount == null ? (
                    <>
                      <h6>Loading</h6>
                    </>
                  ) : (
            ...
            >
              <div>
                <h3 className="fs-2 p-3 fw-bold"> {vehicleCount == null ? (
                    <>
                      <h6>Loading</h6>
                    </>
                  ) : (
            ...
            >
              <div>
                <h3 className="fs-2 p-3 fw-bold"> {driverCount == null ? (
                    <>
                      <h6>Loading</h6>
                    </>
                  ) : (
            ...
            >
              <div>
                <h3 className="fs-2 p-3 fw-bold"> {customerCount == null ? (
                    <>
                      <h6>Loading</h6>
                    </>
                  ) : (
